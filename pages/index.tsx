      ...
      <div className={styles.container}>
        ...
        <section id="priorities" className={styles['content-grid']}>
          <div className={styles.card}>
            <img src="https://cdn.discordapp.com/attachments/1378298825139163136/1389309316145614991/2025-06-30_231852.png?ex=686426a1&is=6862d521&hm=aebbde61b7bb628bffbdd2cbf80e4969d6af6ff60d1846f24aa5772ec93324c4&" alt="Экономика" />
            <h3>Экономика</h3>
            <p>На сервере присутствует экономика! Заработайте свои миллионы и получите кастомную роль!</p>
          </div>
          <div className={styles.card}>
            <img src="https://cdn.discordapp.com/attachments/1378298825139163136/1389310314058878997/image.png?ex=6864278f&is=6862d60f&hm=b0dc5533b6faf71e5d34b417219e9cce78de99efafc4e7d78afa7369133ad86d&" alt="Сообщество" />
            <h3>Сообщество</h3>
            <p>Доброе активное и любящее сообщество!</p>
          </div>
          <div className={styles.card}>
            <img src="https://cdn.discordapp.com/attachments/1378298825139163136/1389310830063128626/2025-06-30_232505.png?ex=6864280a&is=6862d68a&hm=4ee8b042ce413b35b63ef8de1b4b0a617385cc2118b4947049569e5a8d812680&" alt="Голосовые каналы" />
          ...
          <div className={styles.card}>
            <img src="https://cdn.discordapp.com/attachments/1389125003970347058/1389311743439667300/2025-06-30_232843.png?ex=686428e3&is=6862d763&hm=00993f44d5cc709e7f704012250c6958d84b118c05c5e6d820f88d0de9820554&" alt="Картинка" />
        ...
        <footer className={styles.footer}>
          <p>[© 2025 Название сервера. Все права защищены.]</p>
